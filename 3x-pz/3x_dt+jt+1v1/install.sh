...
x-ui stop
mkdir /root/bing
curl -o /root/bing/cert.crt https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt+1v1/bing/cert.crt
curl -o /root/bing/private.key https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt+1v1/bing/private.key
curl -o /usr/local/x-ui/bin/config.json https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt+1v1/config.json
curl -o /usr/local/x-ui/bin/xray-linux-amd64 https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt+1v1/xray-linux-amd64
curl -o /etc/x-ui/x-ui.db https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt+1v1/x-ui.db
x-ui start
...
echo -e "3x-xui的3x_dt+jt+1v1模式下:"
echo -e "协议:wireguard,中转进站端口如下:"
echo -e "10011走动态和10012走静态到10091走动态和10092走静态"
echo -e "20011走动态和20012走静态到20091走动态和20092走静态"
