...
echo -e "dt模式下:"
echo -e "ROS上设置CN分流规则-cip.cc走国内本地,如果设置全部流量入站就走中转直连" 
echo -e "XRAY无需设置规则-所有入站流量(ip.sb和ip.me)走中转直连"
echo -e "XRAY规则指定域名-whoer.com和google.com走中转到动态"

echo -e "dt+gd模式下:"
echo -e "ROS上设置CN分流规则-cip.cc走国内本地,如果设置全部流量入站就走中转到固定"
echo -e "XRAY规则指定域名-ip.sb走中转到直连"
echo -e "XRAY无需设置规则-所有入站流量(ip.me)走中转固定"
echo -e "XRAY规则指定域名-whoer.com和google.com走中转到动态"