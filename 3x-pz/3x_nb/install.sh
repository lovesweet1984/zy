...
echo -e "curl -o /usr/local/x-ui/bin/xray-linux-amd64 https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_nb/xray-linux-amd64"
x-ui start
...
echo -e "3x-xui的3x_nb模式下"
echo -e "常用端口"
echo -e "8100端口：WG协议，Interface PrivateKey:+NRyBuYyDflw0hRpfZQRdyp1n92cpOXs0VPGekZIw24=,Peer PublicKey:ydgIKaGv4lg1S0LUcoQlo4UxpGhWRzZIZJEVpwnRJS4=,Address:10.7.0.2/32"
echo -e "8200端口：WG协议，Interface PrivateKey:+NRyBuYyDflw0hRpfZQRdyp1n92cpOXs0VPGekZIw24=,Peer PublicKey:ydgIKaGv4lg1S0LUcoQlo4UxpGhWRzZIZJEVpwnRJS4=,Address:10.7.0.2/32"
echo -e "8400端口：S5协议，用户名:zy,密码:zy"
echo -e "8500端口：SS协议，密码:zy,加密AES_256_GCM,传输:tcp"
echo -e "8600端口：VL协议，用户:zy, 流控:xtls-rprx-vision，加密方式:none, 传输协议:tcp, 伪装类型:none, 传输层安全:reality, SNI:yahoo.com, Fingerprint:random, PublicKey:IfbuJiRUB2WHGa4SecExlktgpl9wsB4FMGq0vxGjVTU, shortld:ac"
echo -e "8700端口：VM协议，用户zy, 额外ID:0, 加密方式:auto, 传输协议:ws，伪装类型:none, 路径:/, 传输层安全:tls"
echo -e "8800端口：TR协议，密码zy, 传输方式：grpc，SNI:yahoo.com"
...
echo -e "5011组配置"
echo -e "50111：走智能分流"
echo -e "50112：走动态S5（只有google和特定的域名走动态）"
echo -e "50113：走静态S5"
echo -e "50114：走SS"
echo -e "50115：走VL"
echo -e "50116：走VM"
...
echo -e "5012组配置"
echo -e "50121：走智能分流"
echo -e "50122：走动态S5（只有google和特定的域名走动态）"
echo -e "50123：走静态S5"
echo -e "50124：走SS"
echo -e "50125：走VL"
echo -e "50126：走VM"
...
echo -e "5021组配置"
echo -e "50211：走智能分流"
echo -e "50212：走动态S5（只有google和特定的域名走动态）"
echo -e "50213：走静态S5"
echo -e "50214：走SS"
echo -e "50215：走VL"
echo -e "50216：走VM"
...
echo -e "5022组配置"
echo -e "50221：走智能分流"
echo -e "50222：走动态S5（只有google和特定的域名走动态）"
echo -e "50223：走静态S5"
echo -e "50224：走SS"
echo -e "50225：走VL"
echo -e "50226：走VM"
...
echo -e "以此类推"
echo -e "第1个盒子：50111-50117，50181-50187"
echo -e "第2个盒子：50211-50217，50221-50227"
echo -e "第3个盒子：50311-50317，50321-50327"
echo -e "第4个盒子：50411-50417，50421-50427"
echo -e "第5个盒子：50511-50517，50521-50527"
echo -e "第6个盒子：50611-50617，50621-50627"
echo -e "第7个盒子：50711-50717，50721-50727"
echo -e "第8个盒子：50811-50817，50821-50827"
======================================================================================================================================
