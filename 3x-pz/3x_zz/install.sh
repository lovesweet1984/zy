...
echo -e "开始设置3x-xui的3x_zz模式"
x-ui stop
mkdir /root/bing
curl -o /root/bing/cert.crt https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_zz/bing/cert.crt
curl -o /root/bing/private.key https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_zz/bing/private.key
curl -o /usr/local/x-ui/bin/config.json https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_zz/config.json
curl -o /etc/x-ui/x-ui.db https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_zz/x-ui.db
curl -o /usr/local/x-ui/bin/xray-linux-amd64 https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_zz/xray-linux-amd64
x-ui start
echo -e "完成设置3x-xui的3x_zz模式"
