...
echo -e "开始设置3x-xui的3x_dt+jt模式"
x-ui stop
mkdir /root/bing
curl -o /root/bing/cert.crt https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt/bing/cert.crt
curl -o /root/bing/private.key https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt/bing/private.key
curl -o /usr/local/x-ui/bin/config.json https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt/config.json
curl -o /usr/local/x-ui/bin/xray-linux-amd64 https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt/xray-linux-amd64
curl -o /etc/x-ui/x-ui.db https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt/x-ui.db
x-ui start
echo -e "完成设置3x-xui的3x_dt+jt模式"

echo -e "3x-xui的3x_dt+jt模式下各种协议"
