...
curl -o /root/bing/private.key https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt+1v1+google/bing/private.key
curl -o /usr/local/x-ui/bin/config.json https://raw.githubusercontent.com/lovesweet1984/zy/main/3x-pz/3x_dt+jt+1v1+google/config.json
...
echo -e "3x-xui的3x_dt+jt+1v1+google模式下："
